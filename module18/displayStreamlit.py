...
with st.sidebar.form("Book_form"):
    ...
    new_user_rating =  st.slider("User Rating", 0.0, 0.0, 0.1)
...
if submit_button:
    ...
    st.sidebar.success("New book added succesesfully")
...
min_rating = st.sidebar.slidebar("Minimum User Rating", 0.0, 0.5, 0.0, 0.1)
max_price = st.sidebar.slidebar("Max price", 0, books_df['Price'].max(),books_df['Price'].max)
